...
test_that("count_nonzero_a() works", {
  ...
  expect_equal(count_nonzero_a(x), count_nonzero_a_cpp(x))
  expect_equal(count_nonzero_a(y), count_nonzero_a_cpp(y))
  expect_equal(count_nonzero_a(z), count_nonzero_a_cpp(z))
  expect_equal(count_nonzero_a(w), count_nonzero_a_cpp(w))
  expect_equal(count_nonzero_a(x), count_nonzero_a_sp_mat(as(x, "sparseMatrix")))
  expect_equal(count_nonzero_a(y), count_nonzero_a_sp_mat(as(y, "sparseMatrix")))
  expect_equal(count_nonzero_a(z), count_nonzero_a_cube(z))
  expect_equal(count_nonzero_a(w), count_nonzero_a_cube(w))
})
