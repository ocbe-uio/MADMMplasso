...
#' @export
admm.MADMMplasso<-function(beta0,theta0,beta,beta_hat,theta,rho1,X,Z,max_it,W_hat,XtY,y,N,p,K,e.abs, e.rel,alpha,lambda,alph,svd.w,tree,my_print=T,invmat,V,Q,E,EE,O,P,H,HH,cv=cv,gg=0.2){
...
#' Generate the matrix \deqn{\widetilde{W} } as used in Appendix I for use in the function.
#' @export
